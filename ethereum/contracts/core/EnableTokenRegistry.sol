...
import "../dharma-interface/TokenRegistry.sol";
 ...
 */
contract EnableTokenRegistry is TokenRegistry, Ownable {
 ...
 */
    ...
    uint constant private MAX_TOKEN_SYMBOLS = 256;
    mapping (bytes32 => TokenAttributes) public symbolHashToTokenAttributes;
    string[MAX_TOKEN_SYMBOLS] public tokenSymbolList;
    ...
    modifier tokenSlotsAvailable (){
        require (tokenSymbolListLength < MAX_TOKEN_SYMBOLS, 'Total Available slots for tokens exhausted');
        _;
    }
    ...
    function setTokenAttributes(
        ...
        public tokenSlotsAvailable onlyOwner
    {
